...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!DOCTYPE html>\n<html lang="en">\n  <head>\n    <meta charset="utf-8" />\n    <link rel="icon" type="image/png" href="' + assets2 + '/favicon-32x32.png" />\n    <link rel="apple-touch-icon" sizes="48x48" href="' + assets2 + '/favicon-48x48.png" />\n    <link rel="apple-touch-icon" sizes="72x72" href="' + assets2 + '/favicon-72x72.png" />\n    <link rel="apple-touch-icon" sizes="96x96" href="' + assets2 + '/favicon-96x96.png" />\n    <link rel="apple-touch-icon" sizes="256x256" href="' + assets2 + '/favicon-256x256.png" />\n    <link rel="apple-touch-icon" sizes="384x384" href="' + assets2 + '/favicon-384x384.png" />\n    <link rel="apple-touch-icon" sizes="512x512" href="' + assets2 + '/favicon-512x512.png" />\n    <link rel="manifest" href="' + assets2 + '/manifest.webmanifest" crossorigin="anonymous" />\n    <meta name="viewport" content="width=device-width" />\n    ' + head + '\n  </head>\n  <body data-sveltekit-preload-data="hover">\n    <div style="display: contents">' + body + "</div>\n  </body>\n</html>\n",
