    ...
    <footer class="bg-gray-4">
      <div class="mx-auto w-full max-w-screen-xl p-4 py-8 lg:py-16">
          <div class="md:flex md:justify-between">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 w-full md:w-[50%]">
                ...
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <a href="#" class="hover:underline">info@almuqadam.com</a>
                        </li>
                        <li class="mb-4">
                            <a href="#" class="hover:underline">+44 7700 900123</a>
                        </li>
                        <li class="mb-4">
                           <a href="#">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://flowbite.com/" class="hover:underline">Almuqadam</a>. All Rights Reserved.
            </span>
