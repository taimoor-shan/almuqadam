    ...
    <footer class="bg-accent py-12 border-t border-primary-1">
      <div class="mx-auto w-full max-w-screen-xl p-4">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="/" class="hover:underline">Almuqadam</a>. All Rights Reserved.
            </span>
            <div class="flex mt-4 sm:justify-center sm:mt-0">
                ...
                <a href="https://linkedin.com" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
